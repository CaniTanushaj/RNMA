...
//        });
    ...
    private void showPopupDialog(Double result) {
        ...
        Sastojci pecivo = new Sastojci();
        pecivo.sPeciva(result);


        // Set up other TextViews with your ingredient data
        TextView brasnoTextView = myDialog.findViewById(R.id.brasno);
        brasnoTextView.setText("Brasno: "+ pecivo.getBrasno()+"kg");

        TextView vodaTextView = myDialog.findViewById(R.id.voda);
        vodaTextView.setText("Voda: "+ pecivo.getVoda()+"kg");

        TextView solTextView = myDialog.findViewById(R.id.sol);
        solTextView.setText("Sol: "+ pecivo.getSol()+"kg");

        TextView kvasacTextView = myDialog.findViewById(R.id.kvasac);
        kvasacTextView.setText("Kvasac: "+ pecivo.getKvasac()+"kg");

        TextView aditivTextView = myDialog.findViewById(R.id.additiv);
        aditivTextView.setText("Aditiv: "+ pecivo.getAditiv()+"kg");

        TextView uljeTextView = myDialog.findViewById(R.id.ulje);
        uljeTextView.setText("Ulje: "+ pecivo.getUlje()+"kg");

        TextView secerTextView = myDialog.findViewById(R.id.secer);
        secerTextView.setText("Secer: "+ pecivo.getSecer()+"kg");
