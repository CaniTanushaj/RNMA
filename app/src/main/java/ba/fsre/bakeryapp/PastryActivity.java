...
//        recyclerView = findViewById(R.id.recyclerView);
        ...
        kruh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(PastryActivity.this, BreadActivity.class);
                startActivity(i);
            }
        });
//        Dugme za pecivo
        pecivo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PastryActivity.this, BagleActivity.class);
                startActivity(i);
            }
        });
        //Dugme za rekbu
        burek.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PastryActivity.this, PieActivity.class);
                startActivity(i);
            }
        });
        //Dugme za tolisna
        lisnato.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PastryActivity.this, PuffPastryActivity.class);
                startActivity(i);
            }
        });
        ...
        addBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(PastryActivity.this, AddCategory.class);
                startActivity(i);
            }
        });
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.categori) {
                    ...
                    Toast.makeText(PastryActivity.this, "Tijesta", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(PastryActivity.this, PastryActivity.class));
                }
                if (item.getItemId() == R.id.history) {
                    drawerLayout.closeDrawer(GravityCompat.START);
                    Toast.makeText(PastryActivity.this, "Povijest", Toast.LENGTH_SHORT).show();
