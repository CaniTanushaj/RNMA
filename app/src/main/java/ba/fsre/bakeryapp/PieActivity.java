...
//        });
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.categori) {
                    ...
                    Toast.makeText(PieActivity.this, "Kategorije", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(PieActivity.this, PastryActivity.class));
                }
                if (item.getItemId() == R.id.history) {
                    drawerLayout.closeDrawer(GravityCompat.START);
                    Toast.makeText(PieActivity.this, "Povijest", Toast.LENGTH_SHORT).show();
        ...
        databaseReference.orderByChild("category").equalTo("Burek").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
